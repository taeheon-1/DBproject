...
namespace ERP_PROG
{
    public partial class TaskMain : Form
    {
        ...
        string LoginUser = "김가빈";
        public string modTaskId = "";
            ...
            using (MySqlConnection conn = new MySqlConnection(strConn))
            {
                ...
                if (rdr.HasRows)
                {
                    while (rdr.Read())
                    {
                        ...
                        lvi.SubItems.Add(rdr.GetString(9));
        ...
        {
            string query = $"SELECT * FROM number7.task WHERE task_worker = '{LoginUser}'";
        ...
        private void buttonTaskSearch_Click(object sender, EventArgs e)
        {
            ...
            {
                query = $"SELECT * FROM number7.task WHERE task_worker = '{LoginUser}' AND task_writtendate = '{search_keyword}'";
            }
        ...
        private void buttonTaskDelete_Click(object sender, EventArgs e)
        {
            ...
            string load_query = $"SELECT * FROM number7.task WHERE task_worker = '{LoginUser}'";
